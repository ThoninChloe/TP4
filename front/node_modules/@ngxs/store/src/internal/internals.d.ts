...
export declare type StatesByName = ObjectKeyMap<StateClassInternal>;
 ...
 * @ignore
 */
export declare function nameToState(states: StateClassInternal[]): ObjectKeyMap<StateClassInternal>;
/**
